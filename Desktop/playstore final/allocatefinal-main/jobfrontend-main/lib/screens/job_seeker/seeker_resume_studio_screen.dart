...
class _SeekerResumeStudioScreenState extends State<SeekerResumeStudioScreen> {
  ...
  bool _loadingHeadlineAI = false;
  bool _loadingSummaryAI = false;
                ...
                Row(
                  ...
                  children: [
                    Expanded(
                      child: TextField(
                        ...
                        decoration: const InputDecoration(
                          labelText: 'Description / bullets (one per line)',
                    ...
                    StatefulBuilder(
                      ...
                      final isProject = title.toLowerCase().contains('project');
                      final isInternship = title.toLowerCase().contains('internship');
                      return loading
                          ? const Padding(
                          ...
                          : IconButton(
                              ...
                              onPressed: () async {
                                final name = co.text.trim();
                                if (name.isEmpty) {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    const SnackBar(
                                      content: Text('Please enter Title / Company first!'),
                                ...
                                try {
                                  ...
                                  if (isProject) {
                                    ...
                                    prompt = 'Generate a professional 2-3 bullet point description for a project named "$name". Focus on achievements. Output ONLY the bullets (one per line, do not prefix with characters like - or *).';
                                  } else if (isInternship) {
                                    section = 'internship_description';
                                    prompt = 'Generate a professional 2-3 bullet point description of roles and responsibilities for an internship at "$name". Output ONLY the bullets (one per line, do not prefix with characters like - or *).';
                                  } else {
                                    section = 'work_experience_description';
                                    prompt = 'Generate a professional 2-3 bullet point description of roles and responsibilities for a job at "$name". Output ONLY the bullets (one per line, do not prefix with characters like - or *).';
                                  }
                        ...
                        _loadingHeadlineAI
                            ...
                            : IconButton(
                                ...
                                onPressed: () async {
                                  ...
                                  setState(() => _loadingHeadlineAI = true);
                                  try {
                                    final text = await JobSeekerApiService.instance.resumeAiAssist(
                                      sectionName: 'professional_headline',
                                      currentText: _headline.text,
                                      ...
                                      jobContext: 'My skills: $skills. My summary: $summary',
                                    );
                                    setState(() {
                                      _headline.text = text;
                                    });
                                    ...
                                    setState(() => _loadingHeadlineAI = false);
                                  }
                                },
                              ),
                      ],
                            ...
                            : Padding(
                                ...
                                child: IconButton(
                                  ...
                                  onPressed: () async {
                                    ...
                                    setState(() => _loadingSummaryAI = true);
                                    try {
                                      final text = await JobSeekerApiService.instance.resumeAiAssist(
                                        sectionName: 'resume_summary',
                                        currentText: _summary.text,
                                        instruction: 'Generate a professional, compelling resume summary (2-3 sentences). Focus on skills and career achievements. Output ONLY the summary text, no quotes.',
                                        jobContext: 'Headline: $headline. Skills: $skills',
                                      );
                                      setState(() {
                                        _summary.text = text;
                                      });
                                      ...
                                      setState(() => _loadingSummaryAI = false);
                                    }
                                  },
                                ),
                              ),
                      ...
                      children: [
                        ...
                        onPressed: () {
                          showDialog(
                            context: context,
                            builder: (ctx) => AlertDialog(
                              title: Text('Select Proficiency for $lang'),
                              actions: [
                                TextButton(
                                  onPressed: () {
                                    final currentText = _langs.text.trim();
                                    final addition = '$lang — Fluent';
                                    setState(() {
                                      if (currentText.isEmpty) {
                                        _langs.text = addition;
                                      } else {
                                        _langs.text = '$currentText\n$addition';
                                      }
                                    });
                                    Navigator.pop(ctx);
                                  },
