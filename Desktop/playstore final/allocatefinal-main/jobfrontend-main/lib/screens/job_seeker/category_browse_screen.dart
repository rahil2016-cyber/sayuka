...
/// Falls back to all jobs if the selected category has no active postings.
      ...
      return const Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 16),
            Text('Finding jobs in this category…',
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  const Text(
                    'There are no postings for this category yet. Check back soon.',
