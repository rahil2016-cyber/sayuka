...
class _PopularCategoriesSectionState extends State<PopularCategoriesSection> {
  ...
  Future<void> _load() async {
    setState(() {
      _items = const [
        SeekerPopularCategory(
          label: 'Software & IT',
          industryType: 'software_engineering_it',
          iconKey: 'computer_rounded',
        ),
        SeekerPopularCategory(
          label: 'Data & Analytics',
          industryType: 'data_science_analytics',
          iconKey: 'analytics_rounded',
        ),
        SeekerPopularCategory(
          label: 'Design & UX',
          industryType: 'design_ux_creative',
          iconKey: 'palette_rounded',
        ),
        SeekerPopularCategory(
          label: 'Sales & Biz Dev',
          industryType: 'sales_business_development',
          iconKey: 'show_chart_rounded',
        ),
        SeekerPopularCategory(
          label: 'Marketing',
          industryType: 'marketing_digital_growth',
          iconKey: 'campaign_rounded',
        ),
        SeekerPopularCategory(
          label: 'Customer Support',
          industryType: 'customer_success_support',
          iconKey: 'support_agent_rounded',
        ),
      ];
      _loading = false;
      _error = null;
