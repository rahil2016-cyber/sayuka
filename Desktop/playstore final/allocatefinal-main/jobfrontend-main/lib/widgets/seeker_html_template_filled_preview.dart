...
class _SeekerHtmlTemplateFilledPreviewState extends State<SeekerHtmlTemplateFilledPreview> {
  ...
  Widget _layoutForKey(String key) {
    switch (key) {
      ...
      case 't13_academic_clean':
        return Padding(
          padding: const EdgeInsets.all(10),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.stretch,
            children: [
              Text(_name, style: _t(13, Colors.black, FontWeight.w800), maxLines: 1, overflow: TextOverflow.ellipsis),
              const SizedBox(height: 3),
              Text(_title, style: _t(8, Colors.black54, FontWeight.w500), maxLines: 1, overflow: TextOverflow.ellipsis),
              Container(height: 1, margin: const EdgeInsets.only(top: 4, bottom: 8), color: Colors.grey.shade300),
              Expanded(child: _mainBlock(Colors.black, Colors.black87)),
            ],
          ),
        );
