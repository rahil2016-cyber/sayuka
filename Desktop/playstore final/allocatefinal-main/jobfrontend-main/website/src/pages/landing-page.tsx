  ...
  return (
    <div className="min-h-screen bg-[var(--background)]">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-8 px-4 py-8">
        ...
        <footer className="mt-8 border-t border-slate-200 pt-6 text-center text-sm font-semibold text-[var(--text-hint)]">
          <div className="flex flex-wrap justify-center gap-6 mb-3">
            <Link href="/terms-and-conditions" className="hover:text-[var(--primary)] transition">
              Terms &amp; Conditions
            </Link>
            <Link href="/privacy-policy" className="hover:text-[var(--primary)] transition">
              Privacy Policy
            </Link>
