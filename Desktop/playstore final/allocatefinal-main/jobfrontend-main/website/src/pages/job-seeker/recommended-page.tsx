...
export default function JobSeekerRecommendedPage() {
      ...
      >
        <section className="space-y-4">
          <div className="rounded-2xl bg-white p-6 shadow-sm">
            <h1 className="text-2xl font-black">Recommended Jobs</h1>
          </div>
          {loading ? <LoadingState title="Loading recommended jobs..." /> : null}
          ...
          {!loading && !error && !jobs.length ? <EmptyState title="No recommended jobs yet." /> : null}
        </section>
      </SiteShell>
    </Protected>
  );
